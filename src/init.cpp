...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/metallercoin-project/metallercoin>";
    const std::string URL_WEBSITE = "<https://metallercoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Metallercoin version %s\n", FormatFullVersion());
}
