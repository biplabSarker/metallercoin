...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s metallercoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  metallercoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded metallercoin transaction") + "\n" +
              "  metallercoin-tx [options] -create [commands]   " + _("Create hex-encoded metallercoin transaction") + "\n" +
              "\n";
