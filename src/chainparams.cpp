...
{
    const char* pszTimestamp = "MTL is started developed of this day of 2023";
    const CScript genesisOutputScript = CScript() << ParseHex("987654710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1685530786, 2000254979, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x285f17eca3bfad1a49ea5e880c2234e542b6f689a22d53f3f8d9bd2be264b8b3"));
        assert(genesis.hashMerkleRoot == uint256S("0x0491d941bca83e262a2450b52203af72aedd89b287d4dd64ea4b33849a814710"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("34.207.123.194", "34.207.123.194", true));
        //vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        //vSeeds.push_back(CDNSSeedData("metallercointools.com", "dnsseed.metallercointools.com"));
        //vSeeds.push_back(CDNSSeedData("metallercoinpool.org", "dnsseed.metallercoinpool.org"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0x285f17eca3bfad1a49ea5e880c2234e542b6f689a22d53f3f8d9bd2be264b8b3"))
        ...
        chainTxData = ChainTxData{
            ...
            1685530786, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1685530786, 112131, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xc71af620d04e02b77636c0e73e7cfa9e491ae33e03e3eeff59e2c06bd4d91f91"));
        assert(genesis.hashMerkleRoot == uint256S("0x0491d941bca83e262a2450b52203af72aedd89b287d4dd64ea4b33849a814710"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("34.207.123.194", "34.207.123.194"));
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.metallercoin.loshan.co.uk", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0xc71af620d04e02b77636c0e73e7cfa9e491ae33e03e3eeff59e2c06bd4d91f91")),
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1685530786, 0, 0x207fffff, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x6c81b210c311f255117bddafab111747949937ebd1b06b2a8db9584de243742f"));
        assert(genesis.hashMerkleRoot == uint256S("0x0491d941bca83e262a2450b52203af72aedd89b287d4dd64ea4b33849a814710"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x6c81b210c311f255117bddafab111747949937ebd1b06b2a8db9584de243742f"))
        };
